              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="activity">
                    <form class="form-horizontal" action="{{route('user#changePassword')}}" method="POST" enctype="multipart/form-data">
                        @csrf

                      <div class="form-group row">
                        <label for="inputName" class="offset-1 col-sm-11 col-form-label">Old Password</label>
                        <div class="offset-1 col-sm-10">
                          <input type="password" name="userOldPassword" class="form-control"
                          id="inputOldPassword" placeholder="Enter your Old Password..." >
                          @error('userOldPassword')
                            <span>{{$message}}</span>
                          @enderror
                        </div>
                      </div>
